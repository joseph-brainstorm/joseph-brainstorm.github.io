...
For example:
<ul>
 <li>Extensive-form games are polynomial games in behavioral strategies.</li>
 <li>ML architectures such as GAN training can exhibit hidden-monotone structures.</li>
</ul> 
